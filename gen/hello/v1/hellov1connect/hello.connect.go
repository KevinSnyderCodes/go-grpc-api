...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/KevinSnyderCodes/go-grpc-api/gen/hello/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	HelloServiceGreetProcedure = "/hello.v1.HelloService/Greet"
)
...
func NewHelloServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) HelloServiceClient {
	...
	return &helloServiceClient{
		greet: connect.NewClient[v1.GreetRequest, v1.GreetResponse](
			httpClient,
			baseURL+HelloServiceGreetProcedure,
			opts...,
		),
	}
}
...
// Greet calls hello.v1.HelloService.Greet.
func (c *helloServiceClient) Greet(ctx context.Context, req *connect.Request[v1.GreetRequest]) (*connect.Response[v1.GreetResponse], error) {
...
func NewHelloServiceHandler(svc HelloServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	helloServiceGreetHandler := connect.NewUnaryHandler(
		HelloServiceGreetProcedure,
		svc.Greet,
		opts...,
	)
	return "/hello.v1.HelloService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
		case HelloServiceGreetProcedure:
			helloServiceGreetHandler.ServeHTTP(w, r)
		default:
			http.NotFound(w, r)
		}
	})
...
func (UnimplementedHelloServiceHandler) Greet(context.Context, *connect.Request[v1.GreetRequest]) (*connect.Response[v1.GreetResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("hello.v1.HelloService.Greet is not implemented"))
}
